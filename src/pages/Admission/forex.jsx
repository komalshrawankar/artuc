...
import heroImage from "../../assets/admission/forex-bg.png";
import programImage from "../../assets/admission/forex-p.png";
...
const AlliedHealthandScience = () => {
  return (
   ...
   <Navbar/>
   <CoursesHero
  title="Easy & Secure Forex Assistance for Students"
  description="Get reliable support for foreign currency exchange, international payments, and financial transfers for your study abroad journey."
