...
import heroImage from "../../assets/admission/travel-bg.png";
import programImage from "../../assets/admission/travel-p.png";
...
const AlliedHealthandScience = () => {
  return (
   ...
   <Navbar/>
   <CoursesHero
  title="Hassle-Free Travel Assistance for Your Study Abroad Journey"
  description="Get complete support for flight bookings, travel planning, and essential arrangements before you begin your international education journey."
