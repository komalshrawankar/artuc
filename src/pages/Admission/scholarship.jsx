...
import heroImage from "../../assets/admission/schor-bg.png";
import programImage from "../../assets/admission/schlor-p.png";
...
const AlliedHealthandScience = () => {
  return (
   ...
   <Navbar/>
   <CoursesHero
  title="Get Expert Support for Scholarship Applications"
  description="Maximize your chances of receiving scholarships with professional guidance and a strong application strategy."
