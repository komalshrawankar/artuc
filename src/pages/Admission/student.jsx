...
import heroImage from "../../assets/admission/student-bg.png";
...
const AlliedHealthandScience = () => {
  return (
   ...
   <Navbar/>
   <CoursesHero
  title="Find Safe & Comfortable Student Accommodation Abroad"
  description="Get expert assistance in securing the right accommodation near your university for a comfortable and convenient study experience."
