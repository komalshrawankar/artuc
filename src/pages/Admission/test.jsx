...
const AlliedHealthandScience = () => {
  return (
   ...
   <Navbar/>
   <CoursesHero
  title="Achieve Your Best Scores with Expert Test Preparation"
  description="Prepare for international exams with structured training, expert guidance, and proven strategies for success."
