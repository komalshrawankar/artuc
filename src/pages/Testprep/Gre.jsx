...
const processSteps = [
  ...
  },
  {
    ...
    description: "Learn GRE concepts through structured lessons and practice sessions.",
  },
  {
    number: "03",
    title: "Mock Tests",
    description: "Practice with full-length mock exams that simulate the real GRE experience.",
  },
  {
    number: "04",
...
const Gmat = () => {
  ...
  highlight="Course"
  subtitle="Achieve your target GRE score with expert coaching, structured training, and practice tests designed to help you gain admission to top universities worldwide."
...
<InfoSection
  ...
  highlight="GRE?"
  description={[
    "The Graduate Record Examination (GRE) is a globally recognized standardized test required for admission to many graduate and postgraduate programs abroad. Universities use GRE scores to evaluate a candidate’s analytical writing, quantitative reasoning, and verbal reasoning skills.",
    "A strong GRE score can increase your chances of getting admitted to top universities and improve opportunities for scholarships",
  ]}
/>
<WhyChooseTemplate
  bgImage={whyBg}
...
//   afterText="For Your Goal"
  description="At Artuc, we provide comprehensive GRE coaching designed to help students understand the exam format, strengthen their concepts, and improve their performance through regular practice.
...
<HighlightsSection
  ...
  subtitle="Everything you need to succeed in your GRE journey"
...
<ProcessBenefitsSection
  processTitle="Our GRE Preparation"
