...
const processSteps = [
  ...
  },
  {
    ...
    description: "Learn IELTS concepts through structured lessons and practice sessions.",
  },
  {
    number: "03",
    title: "Mock Tests",
    description: "Practice with full-length mock exams that simulate the real IELTS experience.",
  },
  {
    number: "04",
...
const Gmat = () => {
  ...
  highlight="Course"
  subtitle="Achieve your target IELTS score with expert coaching, structured training, and practice tests designed to help you gain admission to top universities worldwide."
...
<InfoSection
  ...
  highlight="IELTS?"
  description={[
    "The Graduate Record Examination (IELTS) is a globally recognized standardized test required for admission to many graduate and postgraduate programs abroad. Universities use IELTS scores to evaluate a candidate’s analytical writing, quantitative reasoning, and verbal reasoning skills.",
    "A strong IELTS score can increase your chances of getting admitted to top universities and improve opportunities for scholarships",
  ]}
/>
<WhyChooseTemplate
  bgImage={whyBg}
...
//   afterText="For Your Goal"
  description="At Artuc, we provide comprehensive IELTS coaching designed to help students understand the exam format, strengthen their concepts, and improve their performance through regular practice.
...
<HighlightsSection
  ...
  subtitle="Everything you need to succeed in your IELTS journey"
...
<ProcessBenefitsSection
  processTitle="Our IELTS Preparation"
