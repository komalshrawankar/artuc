...
import heroImage from "../../assets/studyabroad/china1.png";
import programImage from "../../assets/studyabroad/china2.png";
...
const offeredCourses = [
  ...
  },
  {
    ...
    description:
      "Access various scholarships and financial support options.",
  },
  {
    icon: c6,
    title: "Modern Universities",
    description:
      "Study with advanced learning facilities and campuses.",
  },
];
...
const AlliedHealthandScience = () => {
  return (
   ...
   <Navbar/>
   <CoursesHero
  title="Study in China and Experience Global Education"
  description="Access world-class universities, advanced research opportunities, and a rich cultural experience in one of the world’s leading education destinations."
...
<ProgramInfoSection
  ...
  highlight="China"
  description={[
    "China is one of the fastest-growing destinations for international students, offering globally recognized universities, modern campuses, and strong research programs. The country provides a wide range of undergraduate and postgraduate programs in fields such as engineering, medicine, business, and technology.",

    "Many universities offer English-taught programs, making it easier for international students to pursue higher education in China. Students also benefit from advanced research facilities, experienced faculty, and opportunities to study in a dynamic and rapidly developing economy."
  ]}
/>
