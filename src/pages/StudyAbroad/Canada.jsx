...
import heroImage from "../../assets/studyabroad/canada1.png";
import programImage from "../../assets/studyabroad/canada2.png";
...
const offeredCourses = [
  {
    icon: c1,
    title: "Globally Recognized Institutions",
    description:
      "Study at internationally respected universities and colleges.",
  },
  {
    icon: c2,
    title: "High-Quality Education",
    description:
      "Access modern facilities and excellent academic standards.",
  },
  {
    icon: c3,
    title: "Safe Multicultural Environment",
    description:
      "Live and study in a welcoming and diverse community.",
  },
  {
    icon: c4,
    title: "Affordable Tuition Fees",
    description:
      "Lower education costs compared to many other countries.",
  },
  {
    icon: c5,
  ...
  },
  {
    ...
    description:
      "Benefit from work permits after completing your studies.",
  },
];
...
const AlliedHealthandScience = () => {
  return (
   ...
   <Navbar/>
   <CoursesHero
  title="Study in Canada and Build a Bright Global Future"
  description="Access high-quality education, welcoming communities, and excellent career opportunities in one of the world’s most popular study destinations."
...
<ProgramInfoSection
  ...
  highlight="Canada"
  description={[
    "Canada has become one of the top destinations for international students because of its high-quality education system, globally recognized universities, and welcoming multicultural environment. The country offers a wide range of programs across various fields including business, engineering, healthcare, information technology, and more.",

    "Students studying in Canada benefit from modern research facilities, experienced faculty, and practical learning approaches. The country also provides opportunities for part-time work during studies and post-graduation work permits, allowing students to gain valuable international work experience."
  ]}
/>
